...
- The license was changed from [MIT](https://opensource.org/license/mit) to [GPL-3](https://opensource.org/license/gpl-3-0).
- The list of available packages is now fetched dynamically from CRAN instead of being hardcoded.
- Packages are now called into memory instead of being called for each function.
